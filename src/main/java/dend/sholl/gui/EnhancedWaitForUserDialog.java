...
/** Enhances WaitForUserDialog with a few additional features. Customizations are ignored if running
 * headless. */
public class EnhancedWaitForUserDialog extends WaitForUserDialog {
	private static final long serialVersionUID= 1L;

	/** {@link ij.gui.WaitForUserDialog#WaitForUserDialog(String) WaitForUserDialog constructor}
	 *
