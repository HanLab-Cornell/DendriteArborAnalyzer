...
public class Utils {
	...
	static void addClickableURLtoLabel(final Component label, final String url,
		final Color color) {
		...
		label.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(
				final MouseEvent paramAnonymousMouseEvent) {
				try {
	...
	public static final void improveRecording() {
		if (Recorder.record) {
			String recordString= "// Recording Sholl Analysis version " +
	...
	public static JMenuItem menuItemTrigerringURL(final String label,
		final String URL) {
