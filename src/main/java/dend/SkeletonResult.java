...
public class SkeletonResult {
	...
	public void setListOfStartingSlabVoxels(
		ArrayList<Point> listOfStartingSlabVoxels) {
	...
	/** Calculates and saves the sum of voxels for every tree as the sum of end points, junction voxels
	 * and "normal" voxels.
	 * <p>
	 *
	 * numberOfEndPoints, numberOfJunctionVoxels and numberOfSlabs must exit and have at least
	 * numOfTrees fields each.
	 *
	...
	public int[] calculateNumberOfVoxels() {
		...
		for (int i= 0; i < numOfTrees; ++i) {
			numberOfVoxels[i]= numberOfEndPoints[i] +
				numberOfJunctionVoxels[i] + numberOfSlabs[i];
		}
